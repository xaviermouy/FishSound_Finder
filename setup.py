...
setup(
    ...
    description="Python software to automatically detect fish sounds in passive acustic recordings",
    long_description=readme + '\n\n' + history,
    long_description_content_type="text/x-rst",
    include_package_data=True,
	keywords='fish sounds',
	url="https://github.com/xaviermouy/fish-sound-detector",
    packages=find_packages(include=['fishsound_finder', 'fishsound_finder.*'],exclude=['docs', 'tests','resources']),
